...
function About() {
  ...
  return (<>
    <div className="about-page">
      ...
      <br />
      <p className='text-white'>
        Musico is single-handedly developed by <a href="https://github.com/jaan0" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#FF0000]">Ali Jan</a>, a passionate developer with several
      ...
      <div className="team">
        ...
        <br />
          <p className="text-white"><a href="https://github.com/jaan0" target="_blank" rel="noopener noreferrer" className="text-[#FFD700] hover:text-[#FF0000]">Ali Jan</a> - Developer</p>  
      </div>
