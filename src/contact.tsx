...
const SERVICE_ID = "service_cbethhx";
  ...
  return (
      <div style={{width:'100vw', height: '100vh', display:'flex'}}>
          <form className="formContainer" onSubmit={(e: React.FormEvent<HTMLFormElement>) => handleOnSubmit(e as unknown as { preventDefault: () => void; target: string | HTMLFormElement; })}>
              <h2 className="text-center">Looking for some songs? Send me a message!</h2>
              <br />
              ...
              <div className="formElement">
                  ...
                  <textarea id="from_message" name="from_message" rows={8} cols={30} placeholder="Give me details about the song you're looking for..." required />
              </div>
